                  ...
                  scale)
{
    ...
    features = NULL
    prediction.comp = array(0,
                            c(nrow(X), nlevels(Y), length(test.keepX)),
